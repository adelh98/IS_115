...
<body>
    <?php
        ...
        */ 
        ...
        // Differansen mellom fødselsdagen og fødselsdagen i år, antall år.
        $diffYear = $dateOfBirth->diff($thisDateOfBirth);
        
        // Differansen mellom system dato(i dag) og fødselsdag i år, antall dager.
        $diffDays = $thisDateOfBirth->diff($today)->format("%a"); 
