...
<form method="post" action="#">
    <?php
        ...
        $thisDayOfBirth = new DateTime('29.7.2021'); //Fødselsdagen min i år (Altså 2021)
        ...
        /* differeansen mellom to "Datetime" objekter. Disse er $dateOfBirth, $thisDayOfBirth og $today ^
        */
