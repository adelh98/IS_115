...
<body>
    <?php
        ...
        regneMaskin($tall1, $tall2); //Kaller funksjonene som har logikken
        $tall1++; //For hver gjennomføring så inkrementeres tallet med 1
        }

        //Lager en funksjon, som gjør utregningene
        function regneMaskin($tall1, $tall2) {
